...
export default function PlaylistView({
  ...
  const progressLabel = exportPhase === 'resolve'
    ? `Recherche Apple Music... ${exportProgress.current}/${exportProgress.total}`
    : 'Création de la playlist dans Apple Music...'
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      >
        {exporting ? (
          ...
          <>
            ...
            {exportResult.addedTracks} morceaux ajoutés !
          </>
        ) : (
          <>
            ...
            Créer la playlist dans Apple Music
          </>
        )}
      </button>
      ...
      {exportError && (
        <p className="text-center text-sm text-red-400 mb-4">{exportError}</p>
      )}
